...
if($_SERVER['REQUEST_METHOD'] == 'GET'){
    if(isset($results['status'])) { $status = $results['status']; }
    if(isset($results['payment_type'])) {$payment_type = $results['payment_type']; }
    if(isset($results['payment_type'])) {$payment_method_id = $results['payment_type']; }
    if(isset($results['external_reference'])) {$external_reference = $results['external_reference']; }
    if(isset($results['payment_id'])) {$payment_id = $results['payment_id']; }
}
                            ...
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px;">
                                    <div class="as-producttile-titlepricewraper" style="min-height: 128px;">
                                        ...
                                        <h4 >
                                            Estado de Pago: <?php echo isset($status) ? $status : '' ; ?>
                                        </h4>
                                        <h4 >
                                            Metodo de Pago: <?php echo isset($payment_method_id) ? $payment_method_id : ''; ?>
                                        </h4>
                                        <h4 >
                                            Referencia Externa: <?php echo isset($external_reference) ? $external_reference : ''; ?>
                                        </h4>
                                        <h4 >
                                            ID de Pago: <?php echo isset($payment_id) ? $payment_id : ''; ?>
                                        </h4>
                                    </div>
                                </div>
                            </div>
